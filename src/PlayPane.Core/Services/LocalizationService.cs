...
namespace PlayPane.Core.Services
{
    public sealed class LocalizationService
    {
        private static readonly Dictionary<string, string> English = new Dictionary<string, string>
        {
            ...
            { "Main.Title", "PlayPane" },
            { "Main.Subtitle", "Mirror Chrome or Edge extension streams as a game-friendly overlay" },
            ...
            { "Main.SourcePreview", "Live Extension Preview" },
            ...
            { "Main.ExtensionWaiting", "Waiting for the local signaling server to start." },
            { "Main.ExtensionServerReady", "Listening at {0}. Start PlayPane Capture in Chrome or Edge." },
            { "Main.SignalingAddress", "Local signaling address" },
            { "Main.Instructions", "How to connect" },
            { "Main.ExtensionInstructions", "Open Chrome or Edge, start the PlayPane Capture extension, then use Start Overlay when the preview stream appears." },
            { "Main.PreviewWaiting", "Searching for stream" },
            { "Main.PreviewPaused", "Preview paused" },
            ...
            { "Status.ExtensionClientConnected", "Extension signaling client connected." },
            { "Status.ExtensionClientDisconnected", "Extension signaling client disconnected." },
            ...
            { "Overlay.WebRtcWaiting", "Waiting for the browser extension video stream." },
            { "Overlay.WebRtcMissingSignaling", "The WebRTC signaling server is not available." },
        ...
        private static readonly Dictionary<string, string> SimplifiedChinese = new Dictionary<string, string>
        {
            ...
            { "Main.Title", "PlayPane" },
            { "Main.Subtitle", "通过 Chrome/Edge 扩展镜像视频流" },
            ...
            { "Main.SourcePreview", "扩展实时预览" },
            { "Main.CaptureSource", "捕获来源" },
            { "Main.WindowCaptureSource", "窗口捕获" },
            { "Main.ExtensionCaptureSource", "Chrome/Edge 扩展捕获" },
            { "Main.ExtensionWaiting", "正在准备本地信令服务。" },
            { "Main.ExtensionServerReady", "正在监听：{0}。请在 Chrome 或 Edge 中启动 PlayPane Capture 扩展。" },
            { "Main.SignalingAddress", "本地信令地址" },
            { "Main.Instructions", "连接方式" },
            { "Main.ExtensionInstructions", "打开 Chrome 或 Edge，启动 PlayPane Capture 扩展；预览出现后点击开始覆盖层。" },
            { "Main.PreviewWaiting", "正在搜索视频流" },
            { "Main.PreviewPaused", "预览已暂停" },
            { "Main.Mirroring", "镜像设置" },
            ...
            { "Status.ExtensionClientConnected", "扩展信令客户端已连接。" },
            { "Status.ExtensionClientDisconnected", "扩展信令客户端已断开。" },
            ...
            { "Overlay.WebRtcWaiting", "等待浏览器扩展视频流。" },
            { "Overlay.WebRtcMissingSignaling", "WebRTC 信令服务不可用。" },
            { "Crop.Title", "裁剪源区域" },
