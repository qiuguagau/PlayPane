    ...
    internal static class Program
    {
        private static int Main()
        {
            var tests = new List<Action>
            {
                ...
                ExtensionOffscreenScriptTests.OffscreenCaptureDoesNotPlayDuplicateHiddenVideo,
                ExtensionOffscreenScriptTests.OffscreenCaptureEnforcesRequestedFrameRateAtCaptureAndSender,
                WebView2RuntimeTests.WebRtcViewersUseRuntimeConfiguredForVisibleOverlayPlayback,
